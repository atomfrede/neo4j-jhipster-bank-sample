...
describe('Operation e2e test', () => {
  ...
  it('should load Operations', async () => {
    ...
    expect(await operationComponentsPage.getTitle()).to.eq('sampleNeo4JNoCacheApp.testRootOperation.home.title');
  ...
  it('should load create Operation page', async () => {
    ...
    expect(await operationUpdatePage.getPageTitle()).to.eq('sampleNeo4JNoCacheApp.testRootOperation.home.createOrEditLabel');
  ...
  it('should delete last Operation', async () => {
    ...
    expect(await operationDeleteDialog.getDialogTitle()).to.eq('sampleNeo4JNoCacheApp.testRootOperation.delete.question');
